...
Sleep 300
sendChat("Здравия желаю. Являюсь инспектором ОР УГИБДД по НО, сержант полиции - изменить.")
Return
...
:?:!сос::
SendMessage, 0x50,, 0x4190419,, A
sendChat("/r Докладывает: изменить. Выехал на вызов 'SOS'.")
Return

:?:!сос1::
SendMessage, 0x50,, 0x4190419,, A
sendChat("/r Докладывает: изменить. Прибыл на вызов 'SOS'.")
Return

:?:!выз::
SendMessage, 0x50,, 0x4190419,, A
sendChat("/r Докладывает: изменить. Реагирую на вызов от гражданского.")
Return

:?:!выз1::
SendMessage, 0x50,, 0x4190419,, A
sendChat("/r Докладывает: изменить. Прибыл на вызов от гражданского.")
Return

:?:!ограб::
SendMessage, 0x50,, 0x4190419,, A
sendChat("/r Докладывает: изменить. Выехал на вызов об ограбление.")
Return

:?:!ограб1::
SendMessage, 0x50,, 0x4190419,, A
sendChat("/r Докладывает: изменить. Прибыл на вызов об ограбление.")
Return
...
:?:!визитка::
sendChat("/do На визитке написано: «@изменить».")
Sleep 700
